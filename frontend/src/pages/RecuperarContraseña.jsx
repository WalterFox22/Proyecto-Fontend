...
const RecuperarContra = () => {
  ...
  // Detecta cuando la imagen de fondo termina de cargar
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.success(respuesta.data.msg_recuperacion_contrasenia, {
              ...
              <Form onSubmit={handleSubmit}>
                ...
                <Button
                  ...
                  style={{
                    ...
                    fontSize: "16px",
                    background:
                      "linear-gradient(45deg, #4caf50, #81c784)", // Estilo del botón
