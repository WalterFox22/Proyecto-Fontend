...
const StyledWrapper = styled.div`
  ...
  button::after {
    ...
    top: 10px;
    left: 10px;
    background-color:rgb(219, 185, 166);
    border-radius: 8px;
    z-index: -1;
    transition: all 0.5s;
  }
...
export default ButtonRestPasswordLogin;
